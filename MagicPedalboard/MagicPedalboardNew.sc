...
/* OLD rebuildUnbound { arg listRef;
 ...
 Ndef(leftKey) <<> Ndef(rightKey);
    ...
    *help {
        var text;
        text = "
MagicPedalboardNew.help — quick guide (class-side)

Quick start
-----------
(
var mpb;
mpb = MagicPedalboardNew.new(nil);  // optional display adaptor may be passed
...
";
    ...
    *api {
        ...
        api = IdentityDictionary[
            ...
            \ctor         -> "MagicPedalboardNew.new(displayOrNil)",
